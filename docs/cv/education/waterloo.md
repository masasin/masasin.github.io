...
???+ summary
    ...
    - Completed [numerous projects](#highlighted-projects) across a variety of disciplines including
      [mechatronics](undergrad#mechatronics),
      [mechanical engineering](undergrad#mechanical-engineering),
      [electrical engineering](undergrad#electrical-engineering),
      [computer engineering](undergrad#computer-engineering),
      [controls](undergrad#controls),
      [bioengineering](undergrad#bioengineering),
      [mathematics](undergrad#mathematics),
      and [entrepreneurship](undergrad#entrepreneurship).
...
I also completed [six co-operative education (co-op) internships](coop)
...
In 2012, I directed the EngSoc mental health directorship.
...
A few of them are below, broadly arranged by theme. For more details, please see the [dedicated project page](undergrad).
...
### [Entrepreneurship](undergrad#entrepreneurship)
